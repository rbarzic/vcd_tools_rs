...
- Rust 2024 package version `0.3.0`.
...
- PyPI project `vcd-tools` version `0.3.0`; the console command uses the Python wrapper and exposes Unix `serve` through the compiled extension.
